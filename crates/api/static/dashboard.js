(() => {
  ...
  const elements = {
    ...
    territoryLabel: document.querySelector("#territory-label"),
    h3Resolution: document.querySelector("#h3-resolution"),
    connectionLabel: document.querySelector("#connection-label"),
    refreshButton: document.querySelector("#refresh-button"),
    activeHorizonLabel: document.querySelector("#active-horizon-label"),
    horizonButtons: [...document.querySelectorAll("[data-horizon]")],
    horizonValidAt: document.querySelector("#horizon-valid-at"),
    lastUpdate: document.querySelector("#last-update"),
    maxScore: document.querySelector("#max-score"),
    maxScoreLabel: document.querySelector("#max-score-label"),
    visibleCells: document.querySelector("#visible-cells"),
    alertCount: document.querySelector("#alert-count"),
    alertThresholdLabel: document.querySelector("#alert-threshold-label"),
    ...
    physicalValue: document.querySelector("#physical-value"),
    physicalBar: document.querySelector("#physical-bar"),
    humanValue: document.querySelector("#human-value"),
    humanBar: document.querySelector("#human-bar"),
    fwiGrid: document.querySelector("#fwi-grid"),
    factorList: document.querySelector("#factor-list"),
    historyCount: document.querySelector("#history-count"),
    historyChart: document.querySelector("#history-chart"),
    tooltipPortal: document.querySelector("#tooltip-portal"),
  };
