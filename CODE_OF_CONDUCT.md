...
reported to the maintainers via the reporting channel described in
[`SECURITY.md`](SECURITY.md) (used here for its private-reporting
mechanism, not only for security issues), until a dedicated conduct
contact is published. All complaints will be reviewed and investigated
promptly and fairly.
